      ...
      <table border="0" cellpadding="3" cellspacing="1" width="100%">
        ...
        <tr>
          <td bgcolor="<?php echo htmlspecialchars($alt); ?>">
            <a href="deluser.php?submit=1&amp;user_id=<?php echo htmlspecialchars($user_row['user_id']); ?>"><?php echo htmlspecialchars($user_row['nick']); ?></a> - <?php echo htmlspecialchars($user_row['ugroup_name']); ?>
          </td>
        </tr>
        <?php } ?>
        <tr>
