  ...
  if($submit == 1)
  ...
  else
   {
    ...
    echo makedialog("Datenbank Backup","
         ...
         Das Backup kann auch unter dem Punkt \"Backup ausfuehren\" aufgezogen werden.<br>
         Das Backup beinhaltet nur den Datenbankinhalt, NICHT die Screenshots und die Dateien.
         Diese muessen manuell gebackupt werden.","  OK  ","backup.php");
