...
<head>
 ...
 <title>PowerDownload <?php echo htmlspecialchars($settings['pdlversion']); ?> - Admin</title>
 <link href="style.css" rel="stylesheet" type="text/css">
</head>
<body text="#FFFFFF" bgcolor="<?php echo htmlspecialchars($template['bg']); ?>" bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
  ...
  <tr>
    <td bgcolor="<?php echo htmlspecialchars($template['table_border']); ?>">
      <table border="0" cellpadding="3" cellspacing="1" width="100%" height="100%">
        <tr>
          <td bgcolor="<?php echo htmlspecialchars($template['header_bg']); ?>" width="200" valign="top">
            <table border="0" cellspacing="2" cellpadding="0" width="100%">
              <tr>
                <td align="center">
                  ...
                  if($user_details)
                   {?>
                  Hi <?php echo htmlspecialchars($user_details['nick']); ?><br>
                  [ <a href="index.php?logout=1">Logout</a> | <a href="../<?php echo htmlspecialchars($settings['script_file']); ?>usercenter=profil">Profil</a> ]
                  <?php }
                  else
                   {
          ...
          <td height="15" bgcolor="<?php echo htmlspecialchars($template['header_bg']); ?>">
            <table width="100%" cellpadding="0" cellspacing="0" border="0" height="100%">
              <tr>
                <td height="15">
                  <small>PowerDownload <?php echo htmlspecialchars($settings['pdlversion']); ?> - Admin | <a href="../<?php echo htmlspecialchars($settings['script_file']); ?>"><small>Zur Übersicht</small></a></small>
                </td>
                <td align="right">
              ...
              <tr>
                <td bgcolor="<?php echo htmlspecialchars($template['bg']); ?>" valign="top" height="100%" colspan="2" align="center">
