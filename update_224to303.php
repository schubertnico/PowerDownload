  ...
  <tr>
    <td bgcolor="#9B0000">
      <table border="0" cellpadding="3" cellspacing="1" width="100%" height="100%">
        ...
        <tr>
          <td bgcolor="#3B0000">
            upload_max_filesize (f�r Screenshot/Datei Upload)
          </td>
          <td bgcolor="#3B0000">
            > 0
          </td>
      ...
      <table border="0" cellpadding="3" cellspacing="1" width="100%" height="100%">
        ...
        <tr>
          <td bgcolor="#5F0000" colspan="2">
            Hinweis: Geben sie hier die Tabellennamen von PDL 2.2.4 an. Sollten sie die nicht ge�ndert
            haben lassen sie die Tabellennamen einfach so.<br>
            Mit dem n�chsten Schritt werden alle Daten von PowerDownload umconvertiert.
            Dies kann u.U. sehr lange dauernd, jenachdem wieviel Downloads sie in der Datenbank
            haben und ob sie die Screenshots direkt um�ndern m�chten. Die alte Datenbank bleibt auf jedenfall erhalten auf den Fall hin, das dieses Update
            schiefgeht.<br><br>
            Was gemacht wird jetzt:<br>
            - Alle User werden umgewandelt. Die einteilung in die Usergruppen wird automatisch
            vorgenommen. �berpr�fen sie nach dem Update, ob die User auch alle die richtigen Rechte haben.<br>
            - Die Kommentare werden 1:1 umconvertiert.<br>
            - Die Ordner werden 1:1 umconvertiert.<br>
            - Die Release werden 1:1 umconvertiert.<br>
            - Name der Hauptdatei bzw. der Mirrors wird nach dem Dateinamen der verlinkten Datei vergeben. Bei Mirrors wird noch ein " - Mirror by ..." hinzugef�gt.<br>
            - Alte Settings werden, falls m�glich, �bernommen.
            - Screenshots werden NICHT �bernommen.
          </td>
        </tr>
        <tr>
          <td bgcolor="#2F0000">
...
if($step == 2)
 {
  ...
  echo "<br><br>Update erfolgreich durchgef�hrt. �berpr�fen Sie alle Admins und erstellen sie ggf. neue Usergruppen. �berpr�fen sie alle Release mit mehreren Files. Au�erdem m�ssen sie die alten Screens neu hochladen. L�schen sie nun diese Update Datei.<br><a href=\"pdl-admin/\">weiter zum Admin Center</a>";
