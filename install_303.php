...
Sie k�nnen sich nun ins <a href="pdl-admin/">Admin Interface</a> einloggen.
Dort m�ssen sie zuerst die Einstellungen unter Settings �ndern und die Templates anpassen.<br>
Und nicht vergessen diese Installationsdatei zu l�schen!
    <?php
   }
  else
   { echo "<br>Passwort stimmt nicht mit Best�tigung �berein oder wurde garnicht ausgef�llt.<br><a href=\"javascript:history.back()\">Zur�ck</a>"; }
 }
